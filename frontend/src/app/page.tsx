                ...
                <ScrollAnimation>
                  <div className="max-w-3xl mx-auto">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center items-center">
                      ...
                      <Link
                        href="/contacts"
                        className="btn-secondary group text-base md:text-lg py-3 md:py-4 px-6 md:px-8 flex-1 max-w-xs mx-auto sm:mx-0 border-white/20 text-white bg-white/10 hover:bg-white/20 transition-all justify-center items-center backdrop-blur-sm shadow-lg hover:shadow-xl"
                      >
